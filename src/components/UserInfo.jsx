...
const UserInfo = () => {
  ...
  return (
    <>
      <p className="text-lg text-gray-300 font-semibold bg-gradient-to-r from-yellow-600 to-yellow-300 py-2 px-2 rounded-md sm:w-[100%] sm:mt-5">
      ...
      <div className="flex flex-col justify-center items-start mt-5">
        {user?.isAdmin && (
          <button
            ...
            className="p-3 w-[100%] rounded-md bg-gradient-to-r from-emerald-400 to-emerald-700 text-white font-semibold text-lg shadow-sm"
          >
            View Dashboard
          </button>
        )}
        <button
          ...
          className="p-3 mt-3 w-[100%] rounded-md bg-gradient-to-r from-red-400 to-red-700 text-white font-semibold text-lg shadow-sm"
        >
          Logout
        </button>
      </div>
