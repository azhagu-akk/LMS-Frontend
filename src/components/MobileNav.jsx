...
const MobileNav = ({ status }) => {
  ...
  return (
    <div className="fixed md:flex z-20 justify-around items-center bottom-2 left-2 right-2 bg-gradient-to-br from-blue-900 to-blue-700 p-3 rounded-xl hidden">
      {icons.map((icon, idx) => {
        return (
          <div
            style={{
