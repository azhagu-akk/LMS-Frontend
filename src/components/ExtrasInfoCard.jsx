  ...
  return (
    <>
      <div
        ...
        className=" bg-gradient-to-r from-blue-400 to-blue-700 text-white font-semibold flex justify-between items-center  shadow-sm p-3 w-[100%] mt-5 rounded-md cursor-pointer"
      >
        <p>{card}</p>
        <AiOutlineDown />
      </div>
