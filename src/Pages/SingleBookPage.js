  ...
  return (
    <>
      ...
      <div
        ...
        className="w[100%] h-max pb-20 bg-gradient-to-b from-blue-800 to-blue-700 pt-[80px] overflow-x-hidden"
      >
        <div className="overflow-y-hidden relative -left-3 w-[102%] h-[350px] sm:h-[250px] bg-blue-900 -rotate-3 -top-10">
        ...
        <div className="flex flex-col justify-center items-center w-[100%]">
          ...
          <div className="flex justify-around items-center bg-gradient-to-r from-red-300 to-red-600 w-max px-2 mt-2 rounded-sm">
          ...
          <div className="mt-3">
            <button
              ...
              className="bg-gradient-to-br from-red-400 to-red-600 p-3 rounded-lg text-white capitalize font-bold shadow-lg"
            >
                ...
                return (
                  ...
                  >
                    ...
                    <div className="flex justify-between items-center pr-2">
                      <div className="flex justify-around items-center bg-gradient-to-r from-red-300 to-red-600 w-max px-2 mt-1.5 ml-[1px] rounded-sm">
                        <img
