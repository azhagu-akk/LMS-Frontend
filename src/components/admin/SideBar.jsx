...
const SideBar = ({ dimension, status }) => {
  ...
  return (
    <div
      ...
      className="w-[20%] z-20 sm:w-[80%] ease-in-out duration-500 fixed top-0 left-0 bottom-0 pt-20 bg-gradient-to-b from-blue-700 to-blue-400 sm:-translate-x-[100%]"
    >
              ...
              {data?.subCategory?.map((list, idx) => {
                return (
                  <div
                    ...
                    className="flex cursor-pointer p-2 mt-2  items-center justify-start text-white text-lg border-[1px] border-white rounded-lg"
                  >
                    {list.icon}
